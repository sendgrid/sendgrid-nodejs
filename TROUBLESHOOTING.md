...
All of our examples assume you are using [environment variables](https://github.com/sendgrid/sendgrid-nodejs/blob/master/CONTRIBUTING.md#environment-variables) to hold your SendGrid API key.
