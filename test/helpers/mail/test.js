...
describe('helloEmail', function () {
  ...
  test_payload = '{"from":{"email":"dx@sendgrid.com"},"personalization":[{"to":[{"email":"elmer.thomas@sendgrid.com"}]}],"subject":"Hello World from the SendGrid Node.js Library","content":[{"type":"text/plain","value":"some text here"},{"type":"text/html","value":"<html><body>some text here</body></html>"}]}'
